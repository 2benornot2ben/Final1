...
//	public String calculateClassAverage(String courseName, String assignmentName) {
//		Course course = fullCourseMap.get(courseName);
//		
//	    if (course == null) {
...
//	    }
//	    
//	    HashSet<String> assignment = course.getGradedAssignments(assignmentName);
//	    
//	    if (assignment == null) {
//	        return "Assignment not found.";
//	    }
//	    
//	    ArrayList<Integer> grades = course.getGradesForAssignment(assignmentName);
//	    if (grades.isEmpty()) {
