	...
	public static void showTeacherMenu(Scanner scanner, String teacherUsername, Model model) {
		...
		switch(choice) {
			...
			case "8":
				...
				break;
			case "9":
				// Calculate class averages and medians on assingments(model, username);
//				System.out.println("Enter course name: ");
//			    String courseNameForAverage = scanner.nextLine().strip();
//			    System.out.println("Enter assignment name: ");
//			    String assignmentNameForAverage = scanner.nextLine().strip();
//			    String statsResult = model.calculateClassAverage(courseNameForAverage, assignmentNameForAverage);
